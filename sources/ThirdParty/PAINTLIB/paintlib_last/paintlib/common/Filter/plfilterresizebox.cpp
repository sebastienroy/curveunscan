...
/--------------------------------------------------------------------
|
|      $Id: plfilterresizebox.cpp,v 1.4 2001/10/16 17:12:27 uzadow Exp $
|
...
void PLFilterResizeBox::Apply(PLBmp * pBmpSource, PLBmp * pBmpDest) const
{
