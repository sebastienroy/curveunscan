...
/--------------------------------------------------------------------
|
|      $Id: plbitmap.h,v 1.6 2001/10/21 17:12:39 uzadow Exp $
|
...
inline const PLPoint& PLBmp::GetResolution () const
{
  PLASSERT_VALID(this);
  return m_Resolution;
}
...
inline int PLBmp::GetBitsPerPixel
    () const
{
  PLASSERT_VALID (this);
