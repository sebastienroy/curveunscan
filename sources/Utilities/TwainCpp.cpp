...
void CTwain::GetIdentity()
{
	...
	strcpy (m_AppId.Version.Info, "1.2");
	m_AppId.ProtocolMajor = TWON_PROTOCOLMAJOR;
	m_AppId.ProtocolMinor = TWON_PROTOCOLMINOR;
	m_AppId.SupportedGroups = DG_IMAGE | DG_CONTROL;
	strcpy (m_AppId.Manufacturer, "SquarePoint Software");
	strcpy (m_AppId.ProductFamily, "CurveUnscan");
	strcpy (m_AppId.ProductName, "CurveUnscan");
